...
!function () {
    ...
    b.prototype = {
        ...
        setupPositionAdjustPattern: function () {
            for (
                var a = f.getPatternPosition(this.typeNumber),
                    b = 0;
                b < a.length;
                b++
            ) {
        ...
        setupTypeNumber: function (a) {
            for (
                var b = f.getBCHTypeNumber(this.typeNumber),
                    c = 0;
                18 > c;
                c++
            ) {
...
b.createData = function (a, c, d) {
    ...
    if (g.getLengthInBits() + 4 <= 8 * l) {
        g.put(0, 4);
    }

    while (0 != g.getLengthInBits() % 8) {
        g.putBit(!1);
    }
...
b.createBytes = function (a, b) {
    ...
    var h = new Array(b.length);

    for (var j = 0; j < b.length; j++) {
        var k = b[j].dataCount;
        var l = b[j].totalCount - k;
    ...
    : m()
        ...
        : function () {
            ...
            return a.prototype.draw = function (a) {
                ...
                var k = (b.width - j.offsetWidth) / 2;
                var l = (b.height - j.offsetHeight) / 2;
